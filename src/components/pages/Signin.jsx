        ...
        <div className="w-full  mx-auto  h-full md:w-[50%] lg:w-[40%] p-2 mt-12">
            <div className="">
                <form  className="bg-white w-[80%] mx-auto p-4 rounded-lg ">
                    <h1 className='text-blue-500 font-semibold text-2xl my-3'>JobSeeker</h1>
                    ...
                    <div className={`my-3 rounded-lg border ${usernameError ? "border-red-500" :"border-blue-500"} flex items-center overflow-hidden`}>
                        <div className={`flex items-center justify-center ${usernameError ? "bg-red-500" :"bg-blue-500"} p-2`}>
                            <BiSolidUser className='w-5 h-5 text-white' />
                        </div>
                        <input className='outline-none px-4 text-sm' type="email" placeholder="email" />
                    </div>

                    <div className={`my-3 rounded-lg border ${passwordError ? "border-red-500" :"border-blue-500"}  flex items-center overflow-hidden`}>
                        <div className={`flex items-center justify-center ${passwordError ? "bg-red-500" :"bg-blue-500"} p-2`}>
                            <BiSolidLock className='w-5 h-5 text-white' />
                        </div>
                        <input className='outline-none px-4 text-sm' type="password" placeholder="password" />
                    </div>
                    <div className="my-3">
                    <button className='button bg-blue-600 w-full'>Login</button>
                    </div>
